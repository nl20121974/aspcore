...
with config("html")("styles")
    ...
    .item("check") = "w3-check"
    .item("radio") = "w3-radio"
    .item("button") = "w3-button w3-theme"
    .item("btn") = "w3-button w3-theme"
    .item("submit") = "w3-button w3-theme"
